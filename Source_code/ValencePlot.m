...
[filename, pathname] = uigetfile({'*.e;*.txt', 'All Files (*.e, *.txt)'}, 'Pick a file');
%pathname;
cd(current)
...
% Create line Fe
annotation(Val_Plot,'line',[0.5393 0.6607],[0.3976 0.4167]);

% Create line Fe
annotation(Val_Plot,'line',[0.4679 0.5321],[0.4095 0.3976]);

% Create line Fe
annotation(Val_Plot,'line',[0.3911 0.4118],[0.5357 0.4327]);

% Create line Fe
annotation(Val_Plot,'line',[0.7270 0.7979],[0.6438 0.6543]);
...
% Create line Fe
annotation(Val_Plot,'line',[0.7571 0.7239],[0.5687 0.5687]);%
...
% Create line Fe
annotation(Val_Plot,'line',[0.6772 0.6836],[0.4978 0.4619]);

% Create line Fe
annotation(Val_Plot,'line',[0.4964 0.4643],[0.5595 0.419]);

% Create line Fe
annotation(Val_Plot,'line',[0.6078 0.6768],[0.6635 0.5]);
...
% Create line Fe
annotation(Val_Plot,'line',[0.7994 0.7911],[0.6532 0.5857]);

% Create line Fe
annotation(Val_Plot,'line',[0.2107 0.2217],[0.3929 0.3883]);

% Create line Fe
annotation(Val_Plot,'line',[0.2553 0.2262],[0.3833 0.3891]);
